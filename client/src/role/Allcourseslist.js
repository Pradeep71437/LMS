...
import DataContext from '../Usecontactapi';
import { useNavigate } from 'react-router-dom';
import '../App.css'; // Add this file for styling
          ...
          {totalcourses.map((res) => {
            ...
            return (
              <Col
                ...
                md={6}
                lg={4}
                className="showcourselist1"
                id={res._id}
                key={res._id}
                onClick={(e) => courseselectfn(e)}
              >
                <div
                ...
                >
                  <div className="course-overlay">
                    <h2 className="course-title" id={res._id}>
                      {res.title}
                    </h2>
                    <p className="course-description" id={res._id}>
                      {res.description}
                    </p>
                    <p className="course-language" id={res._id}>
